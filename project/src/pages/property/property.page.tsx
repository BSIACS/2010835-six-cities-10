...
import { reviewsMockData } from '../../mock-data/reviews/reviews';
...
/**Application property page component
*/
export function PropertyPage(): JSX.Element {
  const reviews : Review[] = reviewsMockData;
            ...
            <div className="property__wrapper">
              ...
              <section className="property__reviews reviews">
                ...
                <ul className="reviews__list">
                  {reviews.map((review) => <ReviewItemComponent key={review.id} userName={review.userName} reviewText={review.reviewText} avatarUrl={review.avatarUrl} dataTime={review.date} rating={review.rating}/>)}
                </ul>
